  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed inset-x-0 bottom-0 z-50 mx-auto flex max-h-[80vh] w-full max-w-[480px] flex-col rounded-t-[20px] border-t border-border bg-surface-2 shadow-[0_-20px_60px_-20px_rgba(0,0,0,0.7)]">
